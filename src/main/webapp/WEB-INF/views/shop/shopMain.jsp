...
<body>
    <h1 class="title01">상품리스트</h1>
    
    <h2 class="sortTitle01">스마트폰</h1>
	<div class="card01">
        <c:choose>
            <c:when test="${shopPhonesList[0] == null}">
                <style>.card01{flex-direction: column; justify-content: center; margin:0 auto;}</style>
            <h1>등록된 상품이 없습니다.</h1><br>
            <a href="${contextPath }/main.do"><p class="cls1">메인홈페이지로 가기</p></a>
        </c:when>
        <c:otherwise>
	<c:forEach var="goods" items="${shopPhonesList}">
...
<h2 class="sortTitle01">악세서리</h1>
	<div class="card02">
        <c:choose>
            <c:when test="${shopAccsList[0] == null}">
                <style>.card02{flex-direction: column; justify-content: center; margin:0 auto;}</style>
            <h1>등록된 상품이 없습니다.</h1><br>
            <a href="${contextPath }/main.do"><p class="cls1">메인홈페이지로 가기</p></a>
        </c:when>
        <c:otherwise>
	<c:forEach var="goods" items="${shopAccsList}">
    <div class="product-card">
		<div class="badge">HOT</div>
		<div class="product-tumb">
			<c:choose>
