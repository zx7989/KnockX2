...
<script>
	...
	function backToList(obj){
		obj.action = "${contextPath}/shop/shopMain.do?shop_code=${shop_code}";
		obj.submit();
	}
</script>
<style>
	...
	<c:when test="${result=='enterFailed' }">
		<script>
			window.onload=function(){
				alert("권한이 없습니다. 사업자나 관리자 아이디로 로그인해주세요.");
			}
		</script>
	</c:when>
</c:choose>
...
<body>
    ...
    <body> 
      ...
      <h1 class="title01">상품등록</h1>
        <div class="goodsAddContainer">
	<form  class="goodsAddContainer" name="goodsForm" action="${contextPath}/goods/addNewGoods.do" method="post" enctype="multipart/form-data">
        
            <div class="goodsTop1">
              <span class="sub_title01">상품 대표이미지 등록</span>
                <label for="goods_img1">
                  <div class="gradient-border"><img class="noImg1" src="${contextPath}/resources/image/noImg1.jpg" id="preview" /></div>
                  <div class="btn-upload">파일 업로드하기
                  <input type="file" id="goods_img1" onchange="readURL(this);" name="goods_img1">
                </div>
                </label>
                <span class="sub_title01">상품 추가 이미지 등록</span>
                <label for="goods_img2">
                  <div class="box1"><img class="noSubImg1" src="${contextPath}/resources/image/noSubImg1.png" id="preview1" /></div>
                  <div class="btn-upload">파일 업로드하기
              ...
              <div class="col-md-6 "><span class="material-symbols-outlined" style="font-size: 30px;">
                ...
                <div class="input-group">
                  ...
                  <input type="text" id="myInput" class="input-group__input" value="${gcode.goods_code}" disabled>
                  <input type="hidden" id="goods_code" name="goods_code" value="${gcode.goods_code}" >
                </div>　
                ...
                <div class="input-group">
                  ...
                  <input type="text" value="${scode}" id="myInput" class="input-group__input" name="shop_code" disabled>
                  <input type="hidden" value="${scode}" id="myInput" class="input-group__input" name="shop_code">
              ...
              <div class="input-group">
                ...
                <select id="myInput" class="input-group__input" name="goods_sort" required>
                  <option  value="phone">스마트폰</option>
                  <option value="case">케이스</option>
                  <option value="acc" selected>악세서리</option>
                </select>
              ...
              <div class="input-group">
                ...
                <select id="myInput" class="input-group__input" name="goods_type" placeholder="입력" required>
              ...
              <div class="input-group">
                ...
                <select id="myInput" class="input-group__input" name="goods_volume" placeholder="입력" required>
                  <option value="128GB">128GB</option>
                  <option value="samsung">256GB</option>
                  <option value="samsung">512GB</option>
                  <option value="samsung">1TB</option>
                  <option value="용량없음" selected>용량없음</option>
                </select>
              </div>
              </div>
              <div class="col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input  type="text"id="myInput2" class="input-group__input goods_name" name="goods_name" value="" placeholder="입력" required>
                  <div id="exampleNames">
                ...
                <div class="input-group">
                  ...
                  <input type="text" id="myInput1" class="input-group__input" name="goods_price1" placeholder="가격 입력" required>
                  <input type="hidden" id="goods_price" class="input-group__input" name="goods_price" placeholder="가격 입력" required>
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div>
                  <textarea id="editorTxt" width=100% rows="30" maxlength="4000" name="goods_content1" placeholder="내용을 입력하세요"></textarea>
          ...
          <div class="btnbox1">
            <a><button type="submit" onclick="getEditorContent()"><span>등록</span><div class="liquid"></div></button>
