...
iframe{
        ...
        .rateBox{
          ...
          border:20px solid rgb(0, 69, 196);
          border-radius: 30px;
...
<body>
  ...
  <div class="profile-card">
    ...
    <div class="buttons">
      <button onclick="location.href='${contextPath}/myPage/modMemberForm.do?id=${memInfo.id}&memberSort=${member.memberSort}'">수정</button>
...
$(".album a").click(function(event) {
  ...
  $(this).css({ opacity: 1, marginTop: "0" }); // 앨범이 내려오면서 동시에 나타나는 효과 적용
        ...
        function delOk(){
          ...
          removeMember('${contextPath}/myPage/removeMember.do?id=${memInfo.id}');
        }
			}
