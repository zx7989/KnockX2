...
<body>
  ...
  <body>
    ...
    <div class="container">
      <span id="result" class="typing-text title">안녕하세요. 관리자님.<br>Enter Admin Mode</span>
  </div>
...
<script>
 document.addEventListener("DOMContentLoaded", function() {
  ...
  setTimeout(function() {
    slideContent.style.transform = "translateX(-100%)"; // canvas 왼쪽으로 슬라이딩
  }, 1500);
  
  var slideContent1 = document.getElementsByClassName("container")[0]; // 첫 번째 container 요소 선택

  setTimeout(function() {
    slideContent1.style.transform = "translateX(-100%)"; // container 왼쪽으로 슬라이딩
    setTimeout(function() {
      smoothPageTransition("/admin/main/adminMain.do"); // 부드러운 페이지 이동 처리
    }, 100); // 1초 후에 페이지 이동
  }, 3000);
});
...
function smoothPageTransition(url) {
  ...
  container.style.transform = "translateX(-200%)"; // container 더 왼쪽으로 이동
  setTimeout(function() {
