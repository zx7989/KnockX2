...
<body>
    ...
    <svg style="display:none;">
	  ...
	  <header class="page-header">
		<nav>
		  <a style="background-color: rgb(255, 255, 255);" href="${contextPath}/admin/adminMain.do" class="logo">
			<img src="${contextPath}/resources/image/knock_logo.png" width="200" >
      </img>
		  </a>
	  ...
	  <section class="page-content">
		<section class="search-and-user">
		  ...
		  <div class="admin-profile">
			<span class="greeting">안녕하세요 관리자님</span>
		...
		<footer class="page-footer">
		  <span>KnockX2</span>
		  <a href="${contextPath}/main.do" target="_blank">
