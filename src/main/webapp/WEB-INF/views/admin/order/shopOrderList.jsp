      ...
      <table>
        ...
        <c:otherwise>
          ...
          >
              ...
              <td>
                <form method="post" action="${contextPath}/admin/order/modDelivery.do?order_no=${order.order_no}">
              ...
              <td>
                ...
                <a href="${contextPath}/admin/order/orderResultForm.do?order_no=${order.order_no}">결제 상세보기</a>
              </td>
            </tr>
          </c:forEach>  
        </c:otherwise>
