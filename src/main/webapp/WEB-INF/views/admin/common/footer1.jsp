						...
						<div class="footer-gray">
						  <div class="footer-custom">
							...
							<div class="footer-social">
							  ...
							  <ul>
								<li>
								  <a href="#"onclick="_gaq.push(['_trackSocial', 'Facebook', 'Follow', 'Footer', 'undefined', 'True']);">
								...
								<li>
								  <a href="#"onclick="_gaq.push(['_trackSocial', 'GooglePlus', 'Follow', 'Footer', 'undefined', 'True']);">
								...
								<li>
								  <a href="#"onclick="_gaq.push(['_trackSocial', 'Twitter', 'Follow', 'Footer', 'undefined', 'True']);">
							...
							<div class="footer-legal">
							  <p>&copy; Art.com Inc. All Rights Reserved. | <a href="#"rel="nofollow">Terms of Sale</a></p>
