        ...
        <c:otherwise>
          ...
          <c:forEach var="goods" items="${shopGoodsList}">
            <tr>
              ...
              <td>
                <div class="links01">
                  <a href="${contextPath}/admin/goods/modGoodsForm.do?goods_code=${goods.goods_code}">수정</a>
                  <a href="${contextPath}/admin/goods/removeGoods.do?goods_code=${goods.goods_code}" onclick="return delOk(event); ">삭제</a>
                </div>
              </td>
            </tr>
          </c:forEach>
